...
public class plant_post_list_adapter extends RecyclerView.Adapter<plant_post_list_adapter.viewholder> {

    ArrayList<view_model> dataholder;
    Context context;

    public plant_post_list_adapter(ArrayList<view_model> dataholder, Context context){
        this.dataholder = dataholder;
        this.context = context;
    }
    @NonNull
    @Override
    public plant_post_list_adapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.post_row, parent, false);
        return new viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull plant_post_list_adapter.viewholder holder, int position) {
    ...
    public class viewholder extends RecyclerView.ViewHolder {
        ...
        TextView plant_name_txt;
        //plant_dob_txt, plant_loc_txt, plant_streak_txt;
