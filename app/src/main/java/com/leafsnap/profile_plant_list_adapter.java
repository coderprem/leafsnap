...
public class profile_plant_list_adapter extends RecyclerView.Adapter<profile_plant_list_adapter.viewholder> {

    ArrayList<view_model> dataholder;
    Context context;

    public profile_plant_list_adapter(ArrayList<view_model> dataholder, Context context){
        this.dataholder = dataholder;
        this.context = context;
    }
    @NonNull
    @Override
    public profile_plant_list_adapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.profile_plant_row, parent, false);
        return new viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull profile_plant_list_adapter.viewholder holder, int position) {
