...
public class GardenFragment extends Fragment {
 ...
 FirebaseUser firebaseUser;
    ...
    void get_plant_list(){
        ...
        plant_list_adapter wAdapter = new plant_list_adapter(dataholder, getContext());
        ...
        collectionReference.whereEqualTo("status",true).whereEqualTo("guid",guid)
                ...
                .get().addOnCompleteListener(task -> {
                   ...
                   {
                       ((android.widget.LinearLayout)view.findViewById(R.id.plant_info_txt)).setVisibility(View.VISIBLE);
