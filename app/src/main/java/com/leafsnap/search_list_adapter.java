...
public class search_list_adapter extends RecyclerView.Adapter<search_list_adapter.viewholder> {
    ...
    public search_list_adapter(ArrayList<view_model> dataholder, Context context){
    ...
    @Override
    public void onBindViewHolder(@NonNull search_list_adapter.viewholder holder, int position) {
